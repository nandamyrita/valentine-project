      ...
      {!allCompleted && (
        <Fala
          falas={[
            ...
            {
              texto: 'Eu separei 3 itens dentro do jogo, clique neles e descubra algo.',
      ...
      {allCompleted && (
        <div className="absolute inset-0 z-30 flex items-center justify-center bg-black bg-opacity-70 font-pixel">
          <div className="flex flex-col items-center bg-white border-4 border-pink-500 rounded-xl p-6 text-center max-w-md">
            <img src="/ultimopersonagem.png" alt="Personagem feliz" className="w-40 h-40 mb-4" />
            ...
            <p className="text-pink-600 text-sm">Escaneie para ver a surpresa!</p>
          </div>
        </div>
      )}
    </div>
